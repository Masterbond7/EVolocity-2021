...
volatile float rpmMot = 0;
volatile float rpmPreClutch = 0;
volatile float rpmPostClutch = 0;

volatile unsigned long motRotation = 0;
volatile unsigned long preRotation = 0;
volatile unsigned long postRotation = 0;
