...
def basicHud(): 
    ...
    def basicHudUpdate():
        ...
        if temperatureCheck == 0:
            temperatureCheckImage = ImageTk.PhotoImage(Image.open(os.path.join(os.getcwd(), "Raspberry PI/code/hudImages/temperatureCheckFalse.png")))
            ...
            temperatureCheckImage = ImageTk.PhotoImage(Image.open(os.path.join(os.getcwd(), "Raspberry PI/code/hudImages/temperatureCheckTrue.png")))
            temperatureCheckLight.configure(image=temperatureCheckImage)
            temperatureCheckLight.image = temperatureCheckImage

        # Engine Check Light
        if engineCheck == 0:
            engineCheckImage = ImageTk.PhotoImage(Image.open(os.path.join(os.getcwd(), "Raspberry PI/code/hudImages/engineCheckFalse.jpg")))
            engineCheckLight.configure(image=engineCheckImage)
            engineCheckLight.image = engineCheckImage
        elif engineCheck == 1:
            engineCheckImage = ImageTk.PhotoImage(Image.open(os.path.join(os.getcwd(), "Raspberry PI/code/hudImages/engineCheckTrue.jpg")))
            engineCheckLight.configure(image=engineCheckImage)
            engineCheckLight.image = engineCheckImage

        # Updating Map Image
        mapImage = ImageTk.PhotoImage(Image.open(os.path.join(os.getcwd(), "Raspberry PI/code/hudImages/map.png")))
