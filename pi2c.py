...
while True:
	...
	try:
		...
		if (not pre_data == steering_data[0]) and (not int(int(pre_data)*(180/256)) == int(int(steering_data[0])*(180/256))) and (int(steering_data[0]>=0) and int(steering_data[0]<=254)): #maybe 255 in the future
